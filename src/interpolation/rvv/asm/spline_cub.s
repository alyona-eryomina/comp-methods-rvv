...
spline_cub_rvv_asm:
    ...
    for_point_1:
        ...
        addi t2, zero, 1
        fcvt.s.w ft3, t2 # 1
        vfmv.v.f v0, ft3 # vA = vfmv_v_f_f32m1(1.0f, l);
        vfmv.v.f v2, ft3 # vC = vfmv_v_f_f32m1(1.0f, l);
        addi t2, zero, 4
        fcvt.s.w ft3, t2 # 4
        vfmv.v.f v1, ft3 # vB = vfmv_v_f_f32m1(4.0f, l);

        vle.v v3, (s5) # vPointY = vle32_v_f32m1(pointY + offset - 1, l);
        addi s5, s5, 4
        vle.v v4, (s5) # vPointY2 = vle32_v_f32m1(pointY + offset, l);
        addi s5, s5, 4
        vle.v v5, (s5) # vPointY3 = vle32_v_f32m1(pointY + offset + 1, l);
        addi s5, s5, -8

        addi t2, zero, 2
        fcvt.s.w ft3, t2 # 2
        vfmul.vf v4, v4, ft3 # vPointY2 = vfmul_vf_f32m1(vPointY2, 2.0f, l);

        vfsub.vv v6, v3, v4  # vF = vfsub_vv_f32m1(vPointY, vPointY2, l);
        vfadd.vv v6, v6, v5  # vF = vfadd_vv_f32m1(vF, vPointY3, l);
        vfmul.vf v6, v6, ft2 # vF = vfmul_vf_f32m1(vF, coef, l);

        vse.v v0, (s1) # vse32_v_f32m1(buf->va + offset, vA, l);
        vse.v v1, (s2) # vse32_v_f32m1(buf->vb + offset, vB, l);
        vse.v v2, (s3) # vse32_v_f32m1(buf->vc + offset, vC, l);
        vse.v v6, (s4) # vse32_v_f32m1(buf->F + offset, vF, l);
    ...
    for_run_3:
        ...
        vle.v v0, (s2) # vB = vle32_v_f32m1(buf->b + offset, l);
        addi t3, s2, 4
        vle.v v1, (t3) # vA = vle32_v_f32m1(buf->b + offset + 1, l);

        vfmul.vf v2, v0, ft3 # vC = vfmul_vf_f32m1(vB, 2, l);
        vfadd.vv v2, v2, v1 # vC = vfadd_vv_f32m1(vC, vA, l);
        vfmul.vf v2, v2, ft5  # vC = vfmul_vf_f32m1(vC, h/3, l);

        vfsub.vv v1, v1, v0 # vA = vfsub_vv_f32m1(vA, vB, l);
        vfdiv.vf v1, v1, ft4 # vA = vfdiv_vf_f32m1(vA, 3*h, l);

        vle.v v0, (s4)  # vPointY = vle32_v_f32m1(pointY + offset, l);
        addi t3, s4, 4
        vle.v v3, (t3) # vTmp = vle32_v_f32m1(pointY + offset + 1, l);
        vfsub.vv v3, v3, v0
        vfdiv.vf v3, v3, ft1
        vfsub.vv v2, v3, v2
    ...
    for_main:
        ...
        vfsub.vf v1, v0, ft0 # vTmp = vfsub_vf_f32m1(vSrc, pointX[0], l);
        vfdiv.vf v1, v1, ft1 # vTmp = vfdiv_vf_f32m1(vTmp, h, l);
        vfcvt.xu.f.v v2, v1  # vNum = vfcvt_xu_f_v_u32m1(vTmp, l);
        addi t4, zero, 4
        vmul.vx v1, v2, t4   # vNum = vmul_vx_u32m1(vNum, sizeof(float), l);

        vlxe.v v2, (a3), v1  #  vPointX = vloxei32_v_f32m1(pointX, vNum, l);
        vlxe.v v3, (a4), v1  # vPointY = vloxei32_v_f32m1(pointY, vNum, l);
        vfsub.vv v2, v0, v2  # vX = vfsub_vv_f32m1(vSrc, vPointX, l);

        vlxe.v v0, (s1), v1  # vA = vloxei32_v_f32m1(buf->a, vNum, l);
        vlxe.v v4, (s2), v1  # vB = vloxei32_v_f32m1(buf->b, vNum, l);
        vlxe.v v5, (s3), v1  # vC = vloxei32_v_f32m1(buf->c, vNum, l);

        vfmadd.vv v5, v2, v3 # vTmp = vfmadd_vv_f32m1(vC, vX, vPointY, l);
        vfmadd.vv v0, v2, v4 # vDst = vfmadd_vv_f32m1(vA, vX, vB, l);
        vfmul.vv v2, v2, v2  # vX2 = vfmul_vv_f32m1(vX, vX, l);
        vfmadd.vv v0, v2, v5 # vDst = vfmadd_vv_f32m1(vDst, vX2, vTmp, l);
