...
spline_lin_rvv_asm:
    ...
    for_main:
        ...
        vfsub.vf v4, v0, ft0 # vTmp = vfsub_vf_f32m1(vSrc, pointX[0], l);
        vfdiv.vf v4, v4, ft1 # vTmp = vfdiv_vf_f32m1(vTmp, h, l);
        vfcvt.xu.f.v v8, v4 # vNum = vfcvt_xu_f_v_u32m1(vTmp, l);
        addi t4, zero, 4
        vmul.vx v8, v8, t4   # vNum = vmul_vx_u32m1(vNum, sizeof(float), l);
