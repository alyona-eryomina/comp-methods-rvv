...
spline_par_rvv_asm:
    ...
    for_point_2:
        ...
        vle.v v0, (t3) # vB = vle32_v_f32m8(buf->b + offset, l);
        addi t4, t3, 4
        vle.v v8, (t4) # vA = vle32_v_f32m8(buf->b + offset + 1, l);

        vfsub.vv v8, v8, v0 # vA = vfsub_vv_f32m8(vA, vB, l);
        vfdiv.vf v8, v8, ft5 # vA = vfdiv_vf_f32m8(vA, 2*h, l);
    ...
    for_main:
        ...
        vfdiv.vf v8, v8, ft2 # vTmp = vfdiv_vf_f32m8(vTmp, h, l);
        vfcvt.xu.f.v v16, v8 # vNum = vfcvt_xu_f_v_u32m8(vTmp, l);
        addi t4, zero, 4
        vmul.vx v16, v16, t4   # vNum = vmul_vx_u32m8(vNum, sizeof(float), l);

        vlxe.v v8, (a3), v16 # vX = vloxei32_v_f32m8(pointX, vNum, l);
        vfsub.vv v0, v0, v8  # vSrc2 = vfsub_vv_f32m8(vSrc, vX, l);

        vlxe.v v24, (t3), v16 # vB = vloxei32_v_f32m8(buf->b, vNum, l);
        vlxe.v v8, (a4), v16 # vC = vloxei32_v_f32m8(pointY, vNum, l);
        vfmadd.vv v24, v0, v8 # vDst = vfmadd_vv_f32m8(vB, vSrc2, vC, l);
        vfmul.vv v0, v0, v0  # vSrc2 = vfmul_vv_f32m8(vSrc2, vSrc2, l);

        vlxe.v v8, (t2), v16 # vA = vloxei32_v_f32m8(buf->a, vNum, l);
        vfmadd.vv v8, v0, v24 # vDst = vfmadd_vv_f32m8(vA, vSrc2, vDst, l);
